...
describe('PollAttemptId', function () {
    it('generates a new id', function () {
        $id = PollAttemptId::generate();

        expect($id)->toBeInstanceOf(PollAttemptId::class)
    ...
    it('creates from string', function () {
        ...
        $id = PollAttemptId::fromString($value);
    ...
    it('compares equality correctly', function () {
        ...
        $id1 = PollAttemptId::fromString($value);
        $id2 = PollAttemptId::fromString($value);
        $id3 = PollAttemptId::generate();
